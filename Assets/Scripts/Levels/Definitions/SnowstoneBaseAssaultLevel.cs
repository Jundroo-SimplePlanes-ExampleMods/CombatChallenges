namespace Assets.Scripts.Levels.Definitions
{
   ...
   /// <summary>
   /// The 'Snowstone Base Assault 1' level.
   /// </summary>
   public class SnowstoneBaseAssaultLevel : AssaultLevelBase
   {
      /// <summary>
      ...
      /// </summary>
      private static readonly string LevelGameObject = "SnowstoneBaseAssaultLevel";

      /// <summary>
      /// The level name.
      /// </summary>
      private static readonly string Name = "Snowstone Base Assault 1";

      /// <summary>
      /// Initializes a new instance of the <see cref="SnowstoneBaseAssaultLevel"/> class.
      /// </summary>
      public SnowstoneBaseAssaultLevel()
