namespace Assets.Scripts.Levels.Definitions
{
   ...
   /// <summary>
   /// The 'Seek and Destroy: Krakabloa 1' level.
   /// </summary>
   public class KrakabloaSeekAndDestroy1Level : SeekAndDestroyLevelBase
   {
      /// <summary>
      ...
      /// The level name.
      /// </summary>
      private static readonly string Name = "Seek&Destroy: Krakabloa 1";

      /// <summary>
      /// Initializes a new instance of the <see cref="KrakabloaSeekAndDestroy1Level"/> class.
      /// </summary>
      public KrakabloaSeekAndDestroy1Level()
